...
void ExportCanvas::exportToFile(Canvas* canvas, std::string &filename) {
    prepareCanvas(canvas);
    renderElements(canvas);
    saveToFile(filename, canvas);
}

void ExportCanvas::prepareCanvas(Canvas* canvas) {
...
void ExportCanvas::renderElements(Canvas* canvas) {
...
void ExportCanvas::saveToFile(std::string &filename, Canvas* canvas) {
